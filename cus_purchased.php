...
?>
            ...
            <div
                ...
                No new cars bought yet! <a href="cus_index.php">Explore</a> now!</div>
            ...
            <div class="col-sm-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div
                            style="padding:20px 0;background-color:#F2F3F4; border-radius:5px;text-align:center;margin-top:15px">
...
{
?>
                            <h6 class="card-subtitle mt-2" style="color:black">Discount - <?php echo $row["discount"]?>%
                            </h6>
...
?>
            ...
            <div
                ...
                No resale cars bought yet! <a href="cus_index.php">Explore</a> now!</div>
