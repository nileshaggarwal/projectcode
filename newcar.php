...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/newcar.css?v=<?php echo time(); ?>" />
...
?>
                ...
                <a class="nav-item nav-link" id="nav-gallery-ass" data-toggle="tab" href="#nav-accessories" role="tab"
                    aria-controls="nav-gallery-ass" aria-selected="false">Accessories</a>
                <?php 
}
      ...
      ?>
                        ...
                        <div class="alert alert-info" role="alert">
                            ...
                            <p class="card-text"><b>Price -
                                </b><del><?php echo "Rs ".$firstquery["Price"]?></del><?php echo " Rs ".$newprice." only!" ?>
                            </p>
                        </div>
