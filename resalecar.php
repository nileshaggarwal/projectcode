...
<head>
    <link rel="stylesheet" type="text/css" href="./css/accessories_chosen.css?v=<?php echo time(); ?>" />
...
?>
    ...
    <div class="container-fluid text-white py-3" id="header"
        ...
        <a id="logout" href="logout.php">
            <svg id="person" class="bi bi-x-square" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="white"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
        ...
        <img src="./images/logow.png" onclick="gotodash(<?php echo '\''.$usertype.'\'' ?>)" height="50px"
...
?>
                ...
                <a class="nav-item nav-link" id="nav-features-tab" data-toggle="tab" href="#nav-features" role="tab"
                    aria-controls="nav-features" aria-selected="false">Features</a>
                ...
                <a class="nav-item nav-link" id="nav-gallery-tab" data-toggle="tab" href="#nav-ass" role="tab"
                    aria-controls="nav-ass" aria-selected="false">Accessories</a>
                <?php 
}
                ...
                <div class="card bg-light mb-3" style="margin-top:15px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><b>License plate no</b>
                            ...
                            <li class="list-group-item list-group-item-warning" style="text-align:center">
                                <?php echo $firstquery["licenseplateno"]?></li>
...
?>
                        ...
                        <div class="alert alert-info" role="alert">
                            ...
                            <p class="card-text"><b>Price -
                                </b><del><?php echo "Rs ".$firstquery["resaleprice"]?></del><?php echo " Rs ".$newprice." only!" ?>
                            </p>
                        </div>
...
?>
                ...
                <div class="card bg-light mb-3" style="margin-top:15px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><b>Website - </b><a href="<?php echo $firstquery["dweb"]?>"
                                target="_blank"><?php echo $firstquery["dweb"]?></a></p>
          ...
          ?>
                                    <div class="ass_table1">
                                        ...
                                        <div class="ass_image1">
                                            <div class="imagediv"> <img src=<?php  echo $rows['accessoryphoto'] ?>
                                                    alt="%" /></div>
                                        </div>
                                        <div class="ass_name1">
...
function showimage(event) {
    ...
    if ($(window).width() >= 1000) {
        var div = '<div class="tile" data-scale="2"><div class="photo"><img src="' + event.target.src +
            '"></div></div>' +
            '<button type="button" id="close" class="btn btn-danger" style="margin-top:5px" onclick="closeimage()">Close</button>';
        ...
        var div = '<div id="modal" style="opacity:1"><img src="' + event.target.src + '"></div>' +
            '<button type="button" id="close" class="btn btn-danger" style="margin-top:5px" onclick="closeimage()">Close</button>';
        $('#overlay').append(div);
