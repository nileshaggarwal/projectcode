...
.btn btn-lg btn-success{
    color: linear-gradient(navajowhite,darkorchid);
}


body {
    background-color: linear-gradient(navajowhite,darkorchid);
}
#listicon
{
    position:absolute;
                  ...
                  <form class="form"  method="post" id="update">
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            ...
                            <input type="text" class="form-control" name="branch<?php echo $branch_count?>" id="branch<?php echo $branch_count?>" placeholder="Branch <?php echo $branch_count?> Name" value="<?php echo $branch_row['branch'] ?>" >
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="location<?php echo $branch_count?>"><h4>Branch <?php echo $branch_count?> Location </h4></label>
                            <input type="text" class="form-control" name="location<?php echo $branch_count?>" id="location<?php echo $branch_count?>" placeholder="Branch <?php echo $branch_count?> Location" value="<?php echo $branch_row['location'] ?>">
                        </div>
                    </div>
